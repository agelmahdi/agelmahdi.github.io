document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        ar: {
            ...
            greetingDesc: 'أنا التوأم الرقمي للمهندس أحمد المهدي، متخصص في أنظمة الذكاء الاصطناعي الإنتاجية، وبنى الـ Architecture وبيئات الوكلاء الذاتية.',
        ...
        <ul>
            ...
            <li><strong>التحقق الإحصائي:</strong> مراجعة مخرجات النماذج للتأكد من اتساقها الإحصائي قبل توجيهها للمستخدم النهائي.</li>
                ...
                greeting: `أهلاً بك يا فندم! أنا التوأم الرقمي للبشمهندس المهدي. أقدر أساعدك إزاي النهاردة في استكشاف بنى الذكاء الاصطناعي، الأنظمة الموزعة، أو استراتيجيات تقليل التكاليف؟`,
